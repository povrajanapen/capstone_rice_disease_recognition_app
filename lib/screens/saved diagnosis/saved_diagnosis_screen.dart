          ...
          savedDiagnoses.isEmpty
              ...
              : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final String diagnosisId = diagnosis['id'] as String? ??
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: RiceColors.neutral),
                    ),
                    child: ListTile(
                      //// disease image
                      leading:
                      ...
                      //// disease name
                      title: Text(diagnosis['name'] ?? 'Unknown Disease', style: RiceTextStyles.button),
                      subtitle: Text(
